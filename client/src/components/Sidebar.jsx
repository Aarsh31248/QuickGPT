  ...
  return (
    ...
    >
          ...
          .map((chat) => (
            ...
            >
              <div>
                ...
                <p className="text-xs text-gry-500 dark:text-[#B1A6C0]">
      ...
      <div
        ...
        className="flex items-center gap-2 p-3 mt-4 border border-gray-300 dark:border-white/15 rouned-md cursor-pointer hover:scale-103 transition-all"
      >
        <img
      ...
      {/* Dark Mode Toggle  */}
      <div className="flex items-center justify-between gap-2 p-3 mt-4 border border-gray-300 dark:border-white/15 rouned-md">
      ...
      <div className="flex items-center gap-3 p-3 mt-4 border border-gray-300 dark:border-white/15 rouned-md cursor-pointer group">
